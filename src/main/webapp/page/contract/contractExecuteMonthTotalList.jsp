    	...
    	<div id="searchdiv" class="panel panel-default">
            ...
            <div class="panel-body">
                <form id="formSearch" class="form-horizontal" autosubmit="return false;" method="post" >
                	...
                	<input type="hidden" name="ytmn" id="ytmn" />
                	<input type="hidden" name="reportUser" id="reportUser" value="${realname }" />
                    <div class="form-group" style="margin-top:15px">
                        <label class="control-label col-sm-1" for="year">年份</label>
                        <div class="col-sm-1">
                            <input type="text" class="form-control" id="year" name="year" onchange="setParam()" >
                        </div>
                        <label class="control-label col-sm-1" for="month">月份</label>
                        <div class="col-sm-1">
                            <input type="text" class="form-control" id="month" name="month" onchange="setParam()" >
                        </div>
