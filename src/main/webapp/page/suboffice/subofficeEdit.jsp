...
<script type="text/javascript" src="<%=contextPath%>/js/subofficeEdit.js?ts=<%=request.getAttribute("ts") %>"></script>
	...
	<div id="content" class="content" >
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                	<input type="hidden" name="id" id="id" value="${suboffice.subofficeid}">
                	<input type="hidden" name="isonlysuboid" id="isonlysuboid" value="${suboffice.isonlysubo}">
					<div class="form-group">
						<label for="rolename">部门名称</label>
						<input type="text" class="form-control" id="subofficename" style="width: 400px;" placeholder="请输入部门名称" value="${suboffice.subofficename}">
					</div>
					<div class="form-group">
						<label for="sex">是否分局</label>
